...
Если локальное распознавание даёт много ошибок, можно попробовать OpenAI-профиль или профиль `premium`.
...
## 10. Как добавить автозапуск Windows
